...
@section('content')
<user-cover-photo :src="{{ json_encode(url('storage/' . $user->cover_photo_url)) }}" :change-cover-photo-url="{{ json_encode(route('users.cover_photos.store', $user->id)) }}" :user="{{ json_encode($user) }}"></user-cover-photo>
<div class="py-2">
    <div class="container">
        <div class="row">
            <div class="col-md-3">
